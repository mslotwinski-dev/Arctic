...
$(BUILD_DIR)/arctic.bin: $(BUILD_DIR)/boot.o $(BUILD_DIR)/interrupt.o $(BUILD_DIR)/print.o $(BUILD_DIR)/gdt.o $(BUILD_DIR)/idt.o $(BUILD_DIR)/pic.o $(BUILD_DIR)/pit.o $(BUILD_DIR)/interrupt_handlers.o $(BUILD_DIR)/keyboard.o $(BUILD_DIR)/kernel.o
	$(CC) $(LDFLAGS) $(BUILD_DIR)/boot.o $(BUILD_DIR)/interrupt.o $(BUILD_DIR)/print.o $(BUILD_DIR)/gdt.o $(BUILD_DIR)/idt.o $(BUILD_DIR)/pic.o $(BUILD_DIR)/pit.o $(BUILD_DIR)/interrupt_handlers.o $(BUILD_DIR)/keyboard.o $(BUILD_DIR)/kernel.o -o $(BUILD_DIR)/arctic.bin
